...
### Continuer / Suite de l'entretien

Les boutons `Continuer` et `Suite de l'entretien` sont présents uniquement en mode écriture, sur la partie centrale basse de l'écran.

Le bouton `Continuer`, comme le bouton `Suivant`, permet de naviguer vers la page suivante.  
Il n'est affiché que en mode écriture sur la dernière page atteinte, à condition que la page contienne une réponse.

Le bouton `Suite de l'entretien` permet de revenir directement à la dernière page atteinte, lorsque l'on est revenu en arrière.  
Il n'est affiché que en mode écriture sur les pages qui précèdent la dernière page atteinte, à condition que la page contienne une réponse.
...
Dès lors que la première page d'une séquence ou sous-séquence a été atteinte, il est alors possible de sélectionner cette séquence ou sous-séquence dans le menu pour naviguer directement vers sa première page.
