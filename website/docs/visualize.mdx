...
- une liste de nomenclatures associées au questionnaire pour permettre la recherche sur liste => non obligatoire
  - format exemple : ["pays":"http://....", "communes":"http://...."], ou {"pays":"http://....", "communes":"http://...."} où pays et communes sont les identifiants des nomenclatures utilisées par les suggesters
