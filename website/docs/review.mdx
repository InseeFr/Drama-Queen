...
Le mode de relecture de questionnaire est celui utilisé pour relire le contenu du questionnaire d'une interrogation à partir des données fournies par l'api.
...
- récupération de l'interrogation depuis l'api
...
- l'interrogation n'a pas pu être récupérée (non authentifié, non habilité, unité inexistante)
