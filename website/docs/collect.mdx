...
Pré-requis : avoir effectué une [synchronisation](synchronize.mdx) pour disposer des données associées à l'utilisateur (questionnaires, unité enquêtées, nomenclatures) localement
