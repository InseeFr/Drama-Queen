...
export function getHasDataChanged(changedData: SurveyUnitData) {
...
export function computeFullData(
...
export function removeNullCollectedData(
  data: SurveyUnitData = {},
): SurveyUnitData {
...
export function getNewData(
  ...
  return hasDataChanged
    ? computeFullData(
        ...
        removeNullCollectedData(changedData),
      )
    : currentSurveyUnitData
}
